...
$sqlComposant = 'INSERT INTO composant(nom, marque, categorie, prix, quantite, estPortable, archivage)
        VALUES (:nom, :marque, :categorie, :prix, :quantite, :estPortable, :archivage)';
$pdoStatement = $db->prepare($sqlComposant);

$sqlStock = 'INSERT INTO stock(idComposant, quantite) VALUES
...
$alimentation1->setEstPortable(false);
...
$alimentation2->setEstPortable(false);
...
$alimentation3->setEstPortable(false);
...
$alimentation4->setEstPortable(false);
...
$carteMere1->setEstPortable(false);
...
$carteMere2->setEstPortable(false);
...
$carteMere3->setEstPortable(false);
...
$carteMere4->setEstPortable(false);
...
$disqueDur1->setEstPortable(false);
$disqueDur1->setArchivage(false);
$disqueDur1->setEstSsd(false);
...
$disqueDur2->setEstPortable(false);
$disqueDur2->setArchivage(false);
$disqueDur2->setEstSsd(false);
...
$disqueDur3->setEstPortable(true);
$disqueDur3->setArchivage(false);
$disqueDur3->setEstSsd(true);
...
$disqueDur4->setEstPortable(true);
$disqueDur4->setArchivage(false);
$disqueDur4->setEstSsd(true);
...
$memoireVive1->setEstPortable(false);
$memoireVive1->setArchivage(false);
$memoireVive1->setCapaciteMemoireVive(16);
...
$memoireVive2->setEstPortable(false);
$memoireVive2->setArchivage(false);
$memoireVive2->setCapaciteMemoireVive(32);
...
$memoireVive3->setEstPortable(false);
$memoireVive3->setArchivage(false);
$memoireVive3->setCapaciteMemoireVive(64);
...
$memoireVive4->setEstPortable(false);
$memoireVive4->setArchivage(false);
$memoireVive4->setCapaciteMemoireVive(32);
...
$carteGraphique1->setEstPortable(true);
...
$carteGraphique2->setEstPortable(false);
...
$carteGraphique3->setEstPortable(true);
...
$carteGraphique4->setEstPortable(false);
...
$souris1->setEstPortable(true);
$souris1->setArchivage(false);
$souris1->setSansFil(true);
$souris1->setnbTouches(2);
...
$souris2->setEstPortable(true);
$souris2->setArchivage(false);
$souris2->setSansFil(true);
$souris2->setnbTouches(17);
...
$souris3->setEstPortable(true);
$souris3->setArchivage(false);
$souris3->setSansFil(false);
$souris3->setnbTouches(20);
...
$souris4->setEstPortable(true);
$souris4->setArchivage(false);
$souris4->setSansFil(false);
$souris4->setnbTouches(32);
...
$processeur1->setEstPortable(false);
...
$processeur2->setEstPortable(true);
...
$processeur3->setEstPortable(true);
...
$processeur4->setEstPortable(true);
...
foreach ($composants as $composant) {
    ...
    $pdoStatement->bindValue(':estPortable', $composant->getEstPortable(), PDO::PARAM_STR);
    ...
    if ($composant instanceof Alimentation) {
        ...
        $params = [
            ':id' => $id,
            ':ssd' => $composant->getEstSsd(),
            ':capacite' => $composant->getCapacite(),
        ];
    } elseif ($composant instanceof MemoireVive) {
        $sql = 'INSERT INTO memoire_vive
        VALUES (:id, :capaciteMemoireVive, :nbBarrettes, :type)';
        $params = [
            ':id' => $id,
            ':capaciteMemoireVive' => $composant->getCapaciteMemoireVive(),
        ...
        VALUES (:id, :sansfil, :nbTouches)';
        $params = [
            ':id' => $id,
            ':sansfil' => $composant->getSansFil(),
            ':nbTouches' => $composant->getnbTouches(),
        ];
